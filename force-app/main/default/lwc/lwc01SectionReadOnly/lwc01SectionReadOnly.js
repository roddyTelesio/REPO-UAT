...
//                       this.dispatchEvent(new ShowToastEvent({title: 'Error', message: errorSection.message, variant: 'error'}), );
    ...
    handleSaveSection(){
        ...
        if(this.objSection.Name == ""  || this.objSection.QuoteType__c == null
            ...
            if(this.isTypeOfTreatyQS == true && (isNaN(this.objSection.CapacityPerRisk__c) || this.objSection.CapacityPerRisk__c == "" ) && this.objSection.Unlimited__c == false){
                this.capacityPerRiskEmpty = true;
            }
            if(this.isTypeOfTreatyQS == true && (this.objSection.Cession_Perc__c == undefined ||  isNaN(this.objSection.Cession_Perc__c) )){
                this.cessionPercEmpty = true;
            }
            if(this.isTypeOfTreatyQS == true && (isNaN(this.objSection.Retention__c) || this.objSection.Retention__c == undefined)){
                this.retentionPercEmpty = true;
            }
            if(this.isTypeOfTreatyQS == true && (isNaN(this.objSection.CessionAmount__c) || this.objSection.CessionAmount__c == undefined || this.objSection.CessionAmount__c == "" )){
                this.cessionAmountEmpty = true;
            }
            if(this.isTypeOfTreatyQS == true && ( isNaN(this.objSection.RetentionAmount__c) || this.objSection.RetentionAmount__c == undefined || this.objSection.RetentionAmount__c == "" )){
                this.retentionAmountEmpty = true;
            }
